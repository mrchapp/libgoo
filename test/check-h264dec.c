...
START_TEST (BF0089)
{
	process ("/omx/patterns/P_FrameWorstCase.264",
		 704, 480, OMX_COLOR_FormatYUV420Planar, GOO_TI_VIDEO_DECODER_STREAMMODE);
	return;
}
END_TEST
...
{
	process ("/omx/patterns/P_FrameWorstCase.264",
		 704, 480, OMX_COLOR_FormatYUV420Planar, GOO_TI_VIDEO_DECODER_FRAMEMODE);
	return;
}
END_TEST
...
{
	process ("/omx/patterns/fire_30frames_5_Mbps.264",
		 720, 480, OMX_COLOR_FormatYUV420Planar, GOO_TI_VIDEO_DECODER_FRAMEMODE);
	return;
}
END_TEST
...
START_TEST (BF0132)
{
	process ("/omx/patterns/howtoparkyourmotorcr_nal_frame_qvga.264nb",
		 320, 240, OMX_COLOR_FormatYUV420Planar, GOO_TI_VIDEO_DECODER_FRAMEMODE);
	return;
}
END_TEST
