...
#define ID "OMX.TI.G722.decode"
#define DATAPATH_PARAM_NAME "OMX.TI.index.config.g722dec.datapath"
#define DASF_PARAM_NAME "OMX.TI.index.config.g722headerinfo"
#define FRAME_PARAM_NAME "OMX.TI.index.config.g722headerinfo"
#if 1
#define STREAMID_PARAM_NAME "OMX.TI.index.config.g722streamIDinfo"
#endif
#define INPUT_BUFFERSIZE 1024
#define OUTPUT_BUFFERSIZE 320

G_DEFINE_TYPE (GooTiG722Dec, goo_ti_g722dec, GOO_TYPE_TI_AUDIO_DECODER)

enum _GooTiG722DecProp
{
        PROP_0,
};

static void
goo_ti_g722dec_init (GooTiG722Dec* self)
{
...
static void
goo_ti_g722dec_finalize (GObject* object)
{
        g_assert (GOO_IS_TI_G722DEC (object));
        GooTiG722Dec* self = GOO_TI_G722DEC (object);
        ...
        (*G_OBJECT_CLASS (goo_ti_g722dec_parent_class)->finalize) (object);

        return;
}

static void
goo_ti_g722dec_load_parameters (GooComponent* component)
{
        g_assert (GOO_IS_TI_G722DEC (component));
        GooTiG722Dec* self = GOO_TI_G722DEC (component);
...
static void
goo_ti_g722dec_set_parameters (GooComponent* component)
{
        g_assert (GOO_IS_TI_G722DEC (component));
        GooTiG722Dec* self = GOO_TI_G722DEC (component);
...
static void
goo_ti_g722dec_validate_ports_definitions (GooComponent* component)
{
        g_assert (GOO_IS_TI_G722DEC (component));
        GooTiG722Dec* self = GOO_TI_G722DEC (component);
        g_assert (G_LIKELY(self->input_param));
...
static void
goo_ti_g722dec_set_property (GObject* object, guint prop_id,
...
static void
goo_ti_g722dec_class_init (GooTiG722DecClass* klass)
{
        GObjectClass* g_klass = G_OBJECT_CLASS (klass);
        g_klass->finalize = goo_ti_g722dec_finalize;
	g_klass->set_property = goo_ti_g722dec_set_property;

        //GParamSpec* spec;

        GooComponentClass* o_klass = GOO_COMPONENT_CLASS (klass);
        o_klass->load_parameters_func = goo_ti_g722dec_load_parameters;
        o_klass->set_parameters_func = goo_ti_g722dec_set_parameters;
        o_klass->validate_ports_definition_func =
                goo_ti_g722dec_validate_ports_definitions;
