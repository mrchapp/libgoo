...
G_DEFINE_TYPE (GooTiMpeg4Dec, goo_ti_mpeg4dec, GOO_TYPE_TI_VIDEO_DECODER)

static void
goo_ti_mpeg4dec_validate_ports_definitions (GooComponent* component)
{
        g_assert (GOO_IS_TI_MPEG4DEC (component));
        GooTiMpeg4Dec* self = GOO_TI_MPEG4DEC (component);
...
static void
goo_ti_mpeg4dec_init (GooTiMpeg4Dec* self)
{
        return;
}

static void
goo_ti_mpeg4dec_class_init (GooTiMpeg4DecClass* klass)
{
        GooComponentClass* o_klass = GOO_COMPONENT_CLASS (klass);
        o_klass->validate_ports_definition_func =
                goo_ti_mpeg4dec_validate_ports_definitions;
